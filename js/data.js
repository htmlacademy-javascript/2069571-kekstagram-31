...
const commentID = () => (~~(Math.random() * 1e8)).toString(10); //ID для комментариев, любое уникальное число, диапазон значений отсутсвует, т.к. заранее неизвестно количество комментариев
